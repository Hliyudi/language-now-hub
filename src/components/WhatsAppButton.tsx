...
const INSTAGRAM_URL = "https://www.instagram.com/languagenowpa/";
...
const FloatingContactButton = () => {
  ...
  const linkStyle = (visible: boolean, delay: string): React.CSSProperties => ({
    width: 52,
    height: 52,
  ...
  return (
    ...
    >
      {/* Instagram — plain anchor, identical to header/footer links */}
      <a
        href={INSTAGRAM_URL}
        target="_blank"
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="flex items-center justify-center rounded-full transition-all duration-200 hover:scale-[1.08] cursor-pointer"
        style={linkStyle(open, "0.08s")}
      >
        <svg viewBox="0 0 24 24" width="24" height="24" fill="#25D366" style={{ pointerEvents: "none" }}>
